    ...
    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-12  col-sm-12">
                            <div class="form-group">
                                <label>Логин</label>
                                <input type="text" class="form-control" value="{{ Auth::user()->name }}" required="" autofocus="">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-12  col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ Auth::user()->email }}" required="" autofocus="" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-12  col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required="" value="{{ Auth::user()->tg }}" autofocus="" placeholder="@example">
                            </div>
                        </div><div class="col-xl-6 col-lg-12  col-sm-12">
                            <div class="form-group">
                                <label>VK</label>
                                <input type="text" class="form-control" required="" autofocus="" value="{{ Auth::user()->vk }}" placeholder="Ваша страница вконтакте">
                            </div>
          ...
          <div class="card mb-4">
            <div class="card-body">
              <div class="row">
              	<div class="col-md-12 text-center">
                	...
                	<div class="user-info-avatar" id="ava1"></div>
                    	<img src="" class="gravatar"  data-gravatar_hash=""> 
                   ...
                   <ul class="list_none social_icon">
                        <li><a href="{{ Auth::user()->vk }}"><i class=" fab fa-vk"></i></a></li>
                        <li><a href="{{ Auth::user()->tg }}"><i class=" fab fa-telegram"></i></a></li>
                        <li><a href="mailto://{{ Auth::user()->email }}"><i class=" fas fa-at"></i></a></li>
            ...
            <div class="card-body border-top">
            	<div class="row text-center">
              	<div class="col-md-12">
                  <label class="text-muted ">Текущий тариф</label>
                  <h3><a href="{{ route('plans') }}">{{ Auth::user()->plan }}</a> </h3>
              	</div>
              ...
              <br>
            	<div class="row text-center">
              	<div class="col-md-12">
              	 <label class="text-muted ">Денежный оборот</label>
                  <h3>700₽</h3>
              	</div>

(function($) {
  ...
  /*
  Uncomment to unvisible highlightes to start 
  $('#origcurr').css("display", "none"); 
  $('#modifcurr').css("display", "none"); 
  $('#origpanelcurr li').removeClass('active');
  $('#modifpanelcurr li').removeClass('active');
  
 */
	$('#origpanelcurr li a').click(function(){
		$('#origpanelcurr li').removeClass('active');
		$(this).parent().addClass('active');
		var tagid = $(this).data('tag');
			$('#origcurr').text(tagid);
				$('#origcurr').css("display", "inline"); 
});
	
	$('#modifpanelcurr li a').click(function(){
		$('#modifpanelcurr li').removeClass('active');
		$(this).parent().addClass('active');
		var tagid = $(this).data('tag');
	$('#modifcurr').text(tagid);
				$('#modifcurr').css("display", "inline"); 
	});
  });
